<?php      
    ...
    $admin_message="Thank You";
		...
		$data['msg']="Please enter contact number.";
                ...
                blastEmail($email,"Welcome to SRP BizExcell",$message);
                blastEmail("sagar.pawar@srpbizex.com",'SRP BizExcell',$amsg);
						$data['code']="200";
        ...
        function blastEmail($to,$subject,$message){
            ...
            $mail->IsHTML(true);
            $mail->CharSet = 'UTF-8';
            $mail->Username = "srpbizexcell@gmail.com";
            $mail->Password = 'xmcnmmyhakjuviou';
            $mail->SetFrom("sagar.pawar@srpbizex.com","SRP BizExcell");
